...
public class Case {
    ...
    public Case(){
        ...
        Topping topping2 = new Topping("M&M", 0.15, new ArrayList<>(Arrays.asList("dairy")), 8);
        Topping topping3 = new Topping("Whipped Cream", 0.10, new ArrayList<>(Arrays.asList("dairy")), 6);
